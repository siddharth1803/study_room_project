    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.CharField(choices=[('public', 'public'), ('private', 'private')], default='public', max_length=9)),
                ('pin', models.CharField(default='0000', max_length=4, validators=[django.core.validators.MinLengthValidator(4)])),
