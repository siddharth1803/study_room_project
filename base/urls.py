...
urlpatterns = [
    ...
    path('add_comments/<str:key>/', views.add_comments, name="add_comments"),
    path('delete_room/<str:key>/', views.delete_room, name="delete_room"),
    path('join_room/<str:key>/', views.join_room, name="join_room"),
    path('leave_room/<str:key>/', views.leave_room, name="leave_room"),
